...
class Bio extends React.Component{
  render(){
    ...
    <h2><a href="https://github.com/1030tue" className="nice-link"><i className="github square icon"></i></a>
    <a href="https://www.linkedin.com/in/katekim5809" className="nice-link"><i class="linkedin icon"></i></a></h2>
